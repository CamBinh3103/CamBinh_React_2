...
export default class Content extends Component {
    ...
    renderListglasses = () => {
        return (
            listGlasses.map((item, index) => {
                let imgPart = `./Bài tập glasses/bài tập glasses/glassesImage/${item.url}`
    ...
    render() {
        let model = "./Bài tập glasses/bài tập glasses/glassesImage/model.jpg"
        return (
            <div className='container'>
                <div className='row'>
                    <div className='col-6'>
                        <img style={{ height: "350px", position: "absolute" }} src={model} />
                        <img style={{ position: "relative", width: "180px", opacity: "0.8", marginTop: "85px", marginLeft: "55px" }} src={`./Bài tập glasses/bài tập glasses/glassesImage/${this.state.url}`}></img>
                    ...
                    <div className='col-12' style={{ backgroundColor: "#D3D3D3", marginTop: "50px" }}>
